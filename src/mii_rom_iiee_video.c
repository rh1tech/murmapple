...
/* Modified for murmapple RP2350 port */

#include <pico.h>
#include <stdint.h>
#include "mii_rom.h"

//uint8_t mii_rom_iiee_video[4096] __not_in_flash("mii_rom_iiee_video") __aligned(4096) = {
const uint8_t mii_rom_iiee_video[4096] __aligned(4096) = {
...
/* ROM registration structure for emulator */
